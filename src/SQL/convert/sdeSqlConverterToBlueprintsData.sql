create table eve_helper.assets
(
...
create table eve_helper.blueprint_formula
(
...
create table eve_helper.blueprints
(
...
create table eve_helper.blueprints_data
(
...
create index blueprints_data_pk_blueprint_type_id
    on eve_helper.blueprints_data (blueprint_type_id);

create index blueprints_data_pk_type_id
    on eve_helper.blueprints_data (type_id);

create table eve_helper.esi_config
(
...
create table eve_helper.eve_character
(
    id int auto_increment
        primary key,
    ...
    roles varchar(1023) null,
    refresh_token_char varchar(64) null comment '人物授权',
    refresh_token_crop varchar(64) null comment '军团授权',
    refresh_token_skill varchar(64) null comment '技能列表授权',
    refresh_token_normal varchar(64) null comment '通用授权',
    gmt_create datetime null,
    gmt_modified datetime null,
...
create table eve_helper.industry_job
(
...
create table eve_helper.inv_types
(
...
create table eve_helper.market_groups
(
    market_group_id int null,
...
create table eve_helper.market_order
(
...
create table eve_helper.mining_detail
(
...
create table eve_helper.observer
(
...
alter table eve_helper.observer
    add primary key (observer_id);

create table eve_helper.sys_menu
(
...
create table eve_helper.sys_permission
(
...
create index id
    on eve_helper.sys_permission (id, name);

create index id_2
    on eve_helper.sys_permission (id, name);

create table eve_helper.sys_role
(
    id bigint auto_increment
        primary key,
...
create table eve_helper.sys_role_menu
(
...
create table eve_helper.sys_role_permission
(
...
create index permission_id
    on eve_helper.sys_role_permission (permission_id);

create index role_id
    on eve_helper.sys_role_permission (role_id);

create table eve_helper.sys_user
(
    id int auto_increment
        primary key,
...
create table eve_helper.sys_user_role
(
    user_id int not null comment '用户ID',
...
create table eve_helper.universe_name
(
    id int not null
        primary key,
