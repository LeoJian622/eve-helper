...
class CharacterApiTest {
    ...
    void queryCharacterAgentsResearch() {
        List<AgentsResearchResponse> agentsResearchResponses = characterApi.queryCharacterAgentsResearch(2112818290, "serenity", at).collectList().block();
        System.out.println("agentsResearchResponses = " + agentsResearchResponses);
    }

    @Test
    void queryCharacterBlueprint() {
        List<BlueprintResponse> blueprintResponses = characterApi.queryCharacterBlueprint(2112818290, "serenity", 1, at).collectList().block();
        System.out.println("blueprintResponses = " + blueprintResponses);
    }

    @Test
    void queryCharacterCorporationHistory() {
        List<CorporationHistoryResponse> corporationHistoryResponses = characterApi.queryCharacterCorporationHistory(2112818290, "serenity").collectList().block();
        System.out.println("corporationHistoryResponses = " + corporationHistoryResponses);
    }

    @Test
    void queryCharacterCspa() {
        Float aFloat = characterApi.queryCharacterCspa(2112818290, "serenity", List.of(2112832425, 2112965519, 91424410), at).block();
        System.out.println("aFloat = " + aFloat);
    }

    @Test
    void queryCharacterFatigue() {
        FatigueResponse fatigueResponse = characterApi.queryCharacterFatigue(2112818290, "serenity", at).block();
        System.out.println("fatigueResponse = " + fatigueResponse);
    }

    @Test
    void queryCharacterMedals() {
        List<MedalResponse> fatigueResponses = characterApi.queryCharacterMedals(2112818290, "serenity", at).collectList().block();
        System.out.println("fatigueResponses = " + fatigueResponses);
    }

    @Test
    void queryCharacterNotification() {
        List<NotificationResponse> notificationResponses = characterApi.queryCharacterNotification(2112818290, "serenity", at).collectList().block();
        System.out.println("notificationResponses = " + notificationResponses);
    }

    @Test
    void queryCharacterNotificationContact() {
        List<NotificationContactResponse> notificationContactResponses = characterApi.queryCharacterNotificationContact(2112818290, "serenity", at).collectList().block();
        System.out.println("notificationContactResponses = " + notificationContactResponses);
    }

    @Test
    void queryCharacterPortrait() {
        IconResponse iconResponse = characterApi.queryCharacterPortrait(2112818290, "serenity").block();
        System.out.println("iconResponse = " + iconResponse);
    }

    @Test
    void queryCharacterRoles() {
        RoleResponse roleResponse = characterApi.queryCharacterRoles(2112818290, "serenity", at).block();
        System.out.println("roleResponse = " + roleResponse);
    }

    @Test
    void queryCharacterStanding() {
        List<StandingResponse> standingResponses = characterApi.queryCharacterStanding(2112818290, "serenity", at).collectList().block();
        System.out.println("standingResponses = " + standingResponses);
    }

    @Test
    void queryCharacterTitle() {
        List<TitleResponse> titleResponses = characterApi.queryCharacterTitle(2112818290, "serenity", at).collectList().block();
